...
public class MainActivity extends Activity {
	...
	{
		private boolean barometer_first_time = true;
		...
		public void onSensorChanged(SensorEvent event) {
			...
			else if (event.sensor == rotationSensor)
			{
				...
				yaw.setText(String.format("%.2f", values[2] * 180 / 3.1415962));
				pitch.setText(String.format("%.2f", -values[1] * 180 / 3.1415962));
				roll.setText(String.format("%.2f", values[0] * 180 / 3.1415962));
			}
		}
